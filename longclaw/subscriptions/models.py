...
class SubscriptionOrder(models.Model):
    ...
    subscription = models.OneToOneField('subscriptions.Subscription', related_name='subscription_order', on_delete=models.CASCADE)
...
class SubscriptionOrderItem(models.Model):
    ...
    order = models.ForeignKey('subscriptions.SubscriptionOrder', related_name='items', on_delete=models.CASCADE)
